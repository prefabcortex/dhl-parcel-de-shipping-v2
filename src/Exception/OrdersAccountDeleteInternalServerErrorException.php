...
final class OrdersAccountDeleteInternalServerErrorException extends InternalServerErrorException
{
    ...
    {
        parent::__construct(ErrorMessage::describe($rawResponse, 'Internal Server Error'));
    }
