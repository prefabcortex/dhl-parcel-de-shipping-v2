 ...
 * part. They differ in when the caller supplied the value, not in what went wrong with it — so they
 * are one type, and a consumer who wants to tell them apart reads the message rather than catching
 * a third class.
 *
 ...
 * `catch` is written against; a subclass keeps all three correct and adds the marker. Note the root
 * is load-bearing and not interchangeable with the one {@see MalformedDataException} uses:
