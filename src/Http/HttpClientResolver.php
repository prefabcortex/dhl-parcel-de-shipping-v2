...
final class HttpClientResolver
{
     ...
     * another's. Behind a declared `iterable<string, int>` the names are what they actually are
     * here: data, not references to classes this package depends on.
     *
