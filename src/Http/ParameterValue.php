 ...
 * serialization never has to ask what a value is: there is no `mixed` to narrow, no `is_scalar()`
...
interface ParameterValue
{
     ...
     * callers never have to filter out blanks — a blank would become a stray `&` and thus an extra,
     * empty parameter on the wire.
     *
