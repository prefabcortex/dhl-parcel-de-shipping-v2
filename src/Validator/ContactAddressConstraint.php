    ...
    public static function constraints(): array
    {
        return [
            ...
            new Collection([
                ...
                'dispatchingInformation' => new Optional([
                    new Length(null, 1),
                    new NotBlank(null, null, null),
                ...
                'additionalAddressInformation1' => new Optional([
                    new Length(null, 1),
                    new NotBlank(null, null, null),
                    new Length(null, null, 60),
                    new Type(['string']),
                    new NotNull(),
                ]),
                'additionalAddressInformation2' => new Optional([
                    new Length(null, 1),
                    new NotBlank(null, null, null),
                    new Length(null, null, 60),
                    new Type(['string']),
