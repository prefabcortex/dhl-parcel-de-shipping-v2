...
final class CreateOrdersDocFormatConstraint implements ConstraintProviderInterface
{
    ...
    public static function constraints(): array
    {
        return [
            new Type(['string']),
            new Choice(null, array_map(static fn ($c) => $c->value, CreateOrdersDocFormat::cases())),
            new NotNull(),
        ];
    }
}
