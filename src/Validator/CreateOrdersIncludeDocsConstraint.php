...
final class CreateOrdersIncludeDocsConstraint implements ConstraintProviderInterface
{
    ...
    public static function constraints(): array
    {
        return [
            new Type(['string']),
            new Choice(null, array_map(static fn ($c) => $c->value, CreateOrdersIncludeDocs::cases())),
            new NotNull(),
        ];
    }
}
