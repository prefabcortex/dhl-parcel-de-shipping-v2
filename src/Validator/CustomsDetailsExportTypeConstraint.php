...
final class CustomsDetailsExportTypeConstraint implements ConstraintProviderInterface
{
    ...
    public static function constraints(): array
    {
        return [
            new Type(['string']),
            new Choice(null, array_map(static fn ($c) => $c->value, CustomsDetailsExportType::cases())),
            new NotNull(),
        ];
    }
}
