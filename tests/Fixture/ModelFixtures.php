...
final class ModelFixtures
{
    ...
    {
        return VASDhlRetoure::create('aaaaaaaaaa00aa')
            ->withGoGreenPlus(true);
    }
    ...
    {
        yield 'ServiceInformation' => [self::buildServiceInformation(), ServiceInformationConstraint::constraints()];
        yield 'ServiceInformationAmp' => [
            self::buildServiceInformationAmp(),
        ...
        yield 'Document' => [self::buildDocument(), DocumentConstraint::constraints()];
        yield 'RequestStatus' => [self::buildRequestStatus(), RequestStatusConstraint::constraints()];
        yield 'LabelDataResponse' => [self::buildLabelDataResponse(), LabelDataResponseConstraint::constraints()];
        yield 'ResponseItem' => [self::buildResponseItem(), ResponseItemConstraint::constraints()];
        yield 'ValidationMessageItem' => [
            self::buildValidationMessageItem(),
            ValidationMessageItemConstraint::constraints(),
        ];
        yield 'SingleManifestResponse' => [
            self::buildSingleManifestResponse(),
            SingleManifestResponseConstraint::constraints(),
        ];
        yield 'BillingNoToSheetNo' => [self::buildBillingNoToSheetNo(), BillingNoToSheetNoConstraint::constraints()];
        yield 'ShipmentNoToSheetNo' => [self::buildShipmentNoToSheetNo(), ShipmentNoToSheetNoConstraint::constraints()];
        yield 'MultipleManifestResponse' => [
            self::buildMultipleManifestResponse(),
            MultipleManifestResponseConstraint::constraints(),
        ];
        yield 'ShortResponseItem' => [self::buildShortResponseItem(), ShortResponseItemConstraint::constraints()];
        yield 'ShipmentManifestingRequest' => [
            self::buildShipmentManifestingRequest(),
            ShipmentManifestingRequestConstraint::constraints(),
        ];
        yield 'BankAccount' => [self::buildBankAccount(), BankAccountConstraint::constraints()];
        yield 'Commodity' => [self::buildCommodity(), CommodityConstraint::constraints()];
        yield 'ContactAddress' => [self::buildContactAddress(), ContactAddressConstraint::constraints()];
        yield 'CustomsDetails' => [self::buildCustomsDetails(), CustomsDetailsConstraint::constraints()];
        yield 'Dimensions' => [self::buildDimensions(), DimensionsConstraint::constraints()];
        yield 'Locker' => [self::buildLocker(), LockerConstraint::constraints()];
        yield 'PostOffice' => [self::buildPostOffice(), PostOfficeConstraint::constraints()];
        yield 'POBox' => [self::buildPOBox(), POBoxConstraint::constraints()];
        yield 'Shipment' => [self::buildShipment(), ShipmentConstraint::constraints()];
        yield 'ShipmentDetails' => [self::buildShipmentDetails(), ShipmentDetailsConstraint::constraints()];
        yield 'ShipmentOrderRequest' => [
            self::buildShipmentOrderRequest(),
            ShipmentOrderRequestConstraint::constraints(),
        ];
        yield 'Shipper' => [self::buildShipper(), ShipperConstraint::constraints()];
        yield 'ShipperReference' => [self::buildShipperReference(), ShipperReferenceConstraint::constraints()];
        yield 'VAS' => [self::buildVAS(), VASConstraint::constraints()];
        yield 'VASCashOnDelivery' => [self::buildVASCashOnDelivery(), VASCashOnDeliveryConstraint::constraints()];
        yield 'VASDhlRetoure' => [self::buildVASDhlRetoure(), VASDhlRetoureConstraint::constraints()];
        yield 'VASIdentCheck' => [self::buildVASIdentCheck(), VASIdentCheckConstraint::constraints()];
        yield 'Value' => [self::buildValue(), ValueConstraint::constraints()];
        yield 'Weight' => [self::buildWeight(), WeightConstraint::constraints()];
    }
}
